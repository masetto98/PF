...
namespace Data.Database
{
    public class ServicioTipoPrendaAdapter : Adapter
    {
        ...
        public List<ServicioTipoPrenda> GetAll()
        {
            ...
            try
            {
                serviciosTipoPrendas = _context.ServiciosTipoPrendas.ToList();
            }
            catch (Exception e)
            {
        ...
        public Business.Entities.ServicioTipoPrenda GetOne(int idServicio,int idTipoPrenda)
        {
            try
            {
                return _context.ServiciosTipoPrendas.FirstOrDefault(stp => stp.IdTipoPrenda == idTipoPrenda && stp.IdServicio == idServicio );
            }
            catch (Exception e)
            {
